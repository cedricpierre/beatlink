    ...
    <table style="margin-left: auto; margin-right: auto;" width="100%">
        ...
        <tr valign="top">
            <td width="50%">
                ...
                <?php else: ?>
                    <?php $__currentLoopData = $invoice->accountTaxIds();
                    $__env->addLoop($__currentLoopData);
                    foreach ($__currentLoopData as $taxId): $__env->incrementLoopIndices();
            ...
            <td width="50%">
                ...
                <?php $__currentLoopData = $invoice->customerTaxIds();
                $__env->addLoop($__currentLoopData);
                foreach ($__currentLoopData as $taxId): $__env->incrementLoopIndices();
                    $loop = $__env->getLastLoop(); ?>
                    <?php echo e($taxId->value); ?><br>
        ...
        <tr>
            <td colspan="2">
                ...
                <table width="100%" class="table" border="0">
                    ...
                    <?php $__currentLoopData = $invoice->invoiceLineItems();
                    $__env->addLoop($__currentLoopData);
                    ...
                    <?php if ($invoice->hasDiscount()): ?>
                        <?php $__currentLoopData = $invoice->discounts();
                        $__env->addLoop($__currentLoopData);
                        foreach ($__currentLoopData as $discount): $__env->incrementLoopIndices();
                            $loop = $__env->getLastLoop(); ?>
                    ...
                    <?php else: ?>
                        <?php $__currentLoopData = $invoice->taxes();
                        $__env->addLoop($__currentLoopData);
                        foreach ($__currentLoopData as $tax): $__env->incrementLoopIndices();
                            $loop = $__env->getLastLoop(); ?>
                            <tr>
                                <td></td>
                                <td colspan="3">
...
<?php /**PATH /Users/cedricpierre/Code/BeatLink/.vapor/build/app/vendor/laravel/cashier/resources/views/invoice.blade.php ENDPATH**/ ?>
