                ...
                <div v-if="paymentIntent.status === 'requires_payment_method'" class="mb-3">
                    ...
                    <div v-if="(paymentMethod || {}).remember">
                        ...
                        <p v-if="['bancontact', 'ideal', 'sepa_debit'].includes(paymentMethod.type)" class="text-xs text-gray-400 mb-6">
                            By providing your payment information and confirming this payment, you authorise (A) and Stripe, our payment service provider, to
                            send instructions to your bank to debit your account and (B) your bank to debit your account in accordance with those instructions.
                            ...
                            statement that you can obtain from your bank. You agree to receive notifications for future debits up to 2 days before they occur.
                        </p>
                    </div>
                </div>
...
<?php /**PATH /Users/cedricpierre/Code/BeatLink/.vapor/build/app/vendor/laravel/cashier/resources/views/payment.blade.php ENDPATH**/ ?>
