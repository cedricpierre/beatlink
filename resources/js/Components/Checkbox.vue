    ...
    <div class="form-control">
        <label class="flex items-center space-x-2">
            <input
                ...
                class="h-4 w-4 rounded border-gray-300 shadow-sm focus:ring focus:ring-opacity-50 focus:ring-offset-0 disabled:cursor-not-allowed disabled:bg-gray-50 disabled:text-gray-500"
