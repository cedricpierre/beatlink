                    ...
                    <ul class="w-full flex justify-center flex-col">
                        <li v-for="link in props.campaign.links" :key="link.id" class="w-full my-2">
                            <button
                                ...
                                class="bg-white text-dark hover:bg-gray-50 dark:bg-black dark:text-white dark:hover:bg-gray-800 w-full h-full justify-start px-4 py-2 rounded-xl "
                            >
                                <div class="flex flex-row items-center flex-1">
                                    ...
                                    <div class="flex flex-shrink">
                                        <svg :fill="props.campaign.is_dark ? 'white' : 'black'" class="h-5" viewBox="0 0 256 512"
                ...
                <div class="flex shrink-0 justify-center flex-col mt-4">
                    <div class="mb-2 text-center">
                        <a href="/" target="_blank">
                            <Button :variant="props.campaign.is_dark ? 'ghost' : 'primary'">
                                Create a page
                            </Button>
                        </a>
                    </div>
